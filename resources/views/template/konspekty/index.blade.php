...
@section('konspektContent')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Konspekty</h3>
            <!-- /.box-tools -->
        </div>
        <!-- /.box-header -->
        <div class="box-body no-padding">
            ...
            <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                    ...
                    @if(Route::input('id'))
                        @forelse($konspekty as $konspekt)
                            <tr>
                                <td class="mailbox-subject">{!! Html::linkRoute('konspekty.konspekt.get', $konspekt->title, ['id' => $konspekt->id], []) !!}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center"><em>Nie znaleziono żadnych konspektów w tej kategorii.</em></td>
                            </tr>
                        @endforelse
                    @else
                        <tr>
